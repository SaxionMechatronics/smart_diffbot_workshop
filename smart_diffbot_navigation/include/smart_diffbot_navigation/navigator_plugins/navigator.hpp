...
#ifndef SMART_DIFFBOT_NAVIGATION__NAVIGATOR_PLUGINS__NAVIGATOR_HPP_
#define SMART_DIFFBOT_NAVIGATION__NAVIGATOR_PLUGINS__NAVIGATOR_HPP_
...
{
public:
  using Ptr = std::shared_ptr<smart_diffbot_navigation::Navigator<ActionT>>;
  ...
  bool on_configure(
    ...
    smart_diffbot_navigation::NavigatorMuxer * plugin_muxer,
